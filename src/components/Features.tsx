  ...
  return (
    <section className="py-20 md:py-28 bg-gray-50 dark:bg-black relative overflow-hidden" id="features" ref={sectionRef}>
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-pulse-200/10 to-purple-200/10 rounded-full blur-3xl animate-pulse-slow dark:from-pulse-500/5 dark:to-purple-500/5"></div>
      </div>
