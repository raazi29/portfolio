          ...
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-pulse-50 to-pulse-100 dark:from-purple-900/20 dark:to-pulse-900/20 rounded-2xl border border-pulse-200/30 dark:border-purple-500/20">
