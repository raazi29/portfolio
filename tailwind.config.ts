		...
		extend: {
			colors: {
				...
				dark: {
					...
					"600": "#2a2a2a", // Dark gray
					"500": "#3a3a3a", // Medium dark gray
				},
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			fontFamily: {
				...
				'display': ['Orbitron', 'SF Pro Display', 'Inter', 'sans-serif'],
			...
			boxShadow: {
				...
				'dark-elegant': '0 4px 20px rgba(0, 0, 0, 0.5)',
				'dark-elegant-hover': '0 8px 30px rgba(0, 0, 0, 0.7)',
			}
		}
	},
